...
const Congratulations = () => {
  ...
  useEffect(() => {
    localStorage.clear()
    axios.get("https://roshdstar.onrender.com/api/pages/7")
    .then(res => {
  ...
  return (
    <div className="bg-[#010101] w-full h-full">
      <div>
        ...
        {video7 && <VideoPlayer videoSrc={video7}/>} 

        </div>
        <div className="text-center pt-6 px-4 md:px-16 pb-16 ">
          <p className="text-red-600 leading-[60px] text-3xl font-bold">با تشکر از خرید شما</p>
          <p className="text-white text-xl leading-[45px]">محصولات خریداری شده به ایمیل شما ارسال شده است، میتوانید با مراجعه به ایمیلی که در قسمت ثبت نام وارد کرده بودید به محصولات خریداری خود دسترسی داشته باشید، در نبود فایل spam ایمیل خود را بررسی کنید</p>
        </div>
      </div>
    </div>
  );
